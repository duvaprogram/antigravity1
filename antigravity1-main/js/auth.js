...
const AuthModule = {
    ...
    logout() {
        ...
        // Reset module initialization flags for re-init on next login
        App._initialized = false;
        ProductsModule._initialized = false;
        InventoryModule._initialized = false;
        ClientsModule._initialized = false;
        GuidesModule._initialized = false;
        AnalyticsModule._initialized = false;
        ConfirmationModule._initialized = false;
        PurchasesModule._initialized = false;
        FreightsModule._initialized = false;
        PaymentsModule._initialized = false;
        AccountsModule._initialized = false;
        UsersModule._initialized = false;
        CampaignsModule.initialized = false;
        IncomeStatementModule.initialized = false;
        CalculatorModule.resetInit();
    }
};
